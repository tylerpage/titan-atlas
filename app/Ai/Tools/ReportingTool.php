...
use App\Agents\ReportingAgentContext as AgentContext;
use Illuminate\Contracts\JsonSchema\JsonSchema;
use Laravel\Ai\Contracts\Tool;
use Laravel\Ai\Tools\Request;
use Stringable;

abstract class ReportingTool implements Tool
{
    public function __construct(protected AgentContext $context) {}
