...
<template>
    <AppLayout title="Add user">
        <div class="mb-8">
            ...
            <p class="mt-2 text-slate-600">Create an account directly without sending an email invitation.</p>
        </div>
        ...
        >
            ...
            <div>
                ...
                <div class="space-y-2 rounded-lg border border-slate-200 p-4">
                    ...
                    <p v-if="companies.length === 0" class="text-sm text-slate-500">No companies yet.</p>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="space-y-2 rounded-lg border border-slate-200 p-4">
                    ...
                    <p v-if="visibleDashboards.length === 0" class="text-sm text-slate-500">Select a company to assign dashboards.</p>
                </div>
            </div>

            <div class="flex items-center justify-between gap-4 pt-2">
                <Link :href="route('admin.users.index')" class="text-sm text-slate-600 hover:text-slate-900">Cancel</Link>
                <button
                    type="submit"
